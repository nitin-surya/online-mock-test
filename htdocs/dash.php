...
<title>ONLINE MOCK TEST || DASHBOARD </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">ONLINE MOCK TEST</span></div>
<?php
...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;</span> <a href="account.php" class="log log1">'.$name.'</a>&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
}?>
		...
		<li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="dash.php?q=3">Feedback</a></li>
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="dash.php?q=5">Remove Quiz</a></li>
                ...
                <li class="pull-left"> <a href="logout.php?q=index.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Signout</a></li>
